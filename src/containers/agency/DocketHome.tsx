...
export class DocketHome extends Component<Props, State> {
    ...
    loadData = async () => {
        let res = await axios.get("http://localhost:3002/dockets");
        let data = res.data;
    ...
    saveDocket = async (data: any) => {
        ...
        let res = await axios.post("http://localhost:3002/dockets", data);
    ...
    deleteDocket = async (data: any) => {
        ...
        let res = await axios.delete(`http://localhost:3002/dockets/${data._id}`);
        this.loadData();
    }
